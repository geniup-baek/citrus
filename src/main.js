...
// (pesticide:manual은 API가 아니라 사용자가 직접 등록한 농약 목록 — 같은 방식으로 기기 간 공유한다)
;['pesticide:all', 'pesticide:manual', 'pest:diseases:all', 'pest:pathogens:all', 'pest:insects:all', 'pest:prediction']
